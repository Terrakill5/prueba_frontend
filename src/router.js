...
router.beforeEach(async (to, from, next) => { //como se va a usar una promesa del getCurrentUser la funcion debe ser asincrona
  if (to.matched.some((record) => record.meta.requiresAuth)) {
    //verifica si la pagina necesita verificacion
    if (await getCurrentUser()) { //se verifica con la anterior promesa que el usuario esta logeado o no cuando se reinicia la pagina
